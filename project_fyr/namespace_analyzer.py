    ...
    def _generate_ai_analysis(
        ...
        try:
            ...
            investigation_request = (
                f"Investigate namespace '{namespace}' and summarize the key issues.\n\n"
                f"{context}\n\n"
                f"INSTRUCTIONS:\n"
                ...
                f"3. Identify the most likely root cause(s) and impact\n"
                f"4. Provide only the most important actionable next steps\n"
                f"5. Keep the response concise and focused\n\n"
                f"IMPORTANT NOTES:\n"
                ...
                f"- Use simple language and avoid long report-style formatting\n"
                f"- Limit recommendations to high-impact next actions only\n\n"
